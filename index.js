...
const worldCupRouter = require('./routes/get-worldcup')
...
const mobileLeagueRouter = require('./routes/mobile-league')
const routeAuth = require('./routes/get4-auth')
const vipSelectionRouter = require('./routes/vip-selection')
const vipBetslipsRouter = require('./routes/vip-betslips')
...
app.use(mobileLeagueRouter)
app.use(googleAuthRouter)
app.use(vipBetslipsRouter)
app.use(routeAuth)
